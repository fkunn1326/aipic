            ...
            <div className="mt-4 mb-60 flex flex-col items-center justify-center lg:py-0">
                <div className="w-full bg-white md:mt-0 sm:max-w-2xl xl:p-0">
                    <div className="">
                        ...
                        >
                            <div className="flex justify-center items-center w-full" onDragOver={(e) => handledrag(e)} onDragLeave={(e) => handledrag(e)} onDrop={(e) => (handledrop(e))}>
                                {!isSelected ?
                                <label className={`flex flex-col justify-center items-center w-full h-64 bg-gray-50 rounded-lg border-2 border-gray-300 border-dashed cursor-pointer hover:bg-gray-100 ${isdropping && 'border-4 border-sky-500 bg-sky-100'}`}>
                                ...
                                <div className="flex flex-col justify-center items-center w-full h-96 bg-gray-50 rounded-lg border-2 border-gray-300 border-dashed cursor-pointer relative">
                                    <XCircleIcon className='absolute z-10 text-sky-400 w-8 h-8 top-2 right-2 bg-gray-50 rounded-full hover:text-sky-500' onClick={() => {setisSelected(false)}}></XCircleIcon>
                                    <Image src={imageurl}
                                        layout="fill"
                            ...
                            <button
                                type="submit"
                                className={`w-full text-white font-medium rounded-lg text-sm px-5 py-2.5 text-center ${!isSending ? "bg-sky-500 hover:bg-sky-600 focus:ring-4 focus:outline-none focus:ring-sky-300" : "bg-sky-300"}`}
                                disabled={isSending}
                            >
                                投稿する
                            </button>
