        ...
        <div className="dark:bg-slate-900 dark:text-white">
          ...
          <div className="py-12 px-10 sm:px-32 m-auto xl:max-w-7xl">
            ...
            <div className="pt-8">
              ...
              <ol className="flex flex-col gap-2 pt-4 pl-8 list-decimal">
                <li>If there is any conflict in this <a href="/en/terms/tos">English version of the Terms and Conditions</a> and the <a href="/terms/tos">Japanese version of Terms and Conditions</a>, the Japanese Terms and Conditions will be always prioritized.</li>
