    ...
    return (
        <div>
            ...
            <div className="py-12 px-10 sm:px-32 m-auto xl:max-w-7xl">
                ...
                <div className="pt-8">
                    <h1 className="text-xl font-bold">第3条（ユーザーIDおよびパスワードの管理）</h1>
                    <ol className="flex flex-col gap-2 pt-4 pl-8 list-decimal">
                ...
                <div className="pt-8">
                    ...
                    <p className="pt-4">ユーザーは，本サービスの利用にあたり，以下の行為をしてはなりません。</p>
                    <ol className="flex flex-col gap-2 pt-4 pl-8 list-decimal">
                ...
                <div className="pt-8">
                    <h1 className="text-xl font-bold">第5条（本サービスの提供の停止等）</h1>
                    <ol className="flex flex-col gap-2 pt-4 pl-8 list-decimal">
                ...
                <div className="pt-8">
                    ...
                    <p className="pt-4">ユーザーは，運営者の定める退会手続により，本サービスから退会できるものとします。</p>
                </div>
                <div className="pt-8">
                    <h1 className="text-xl font-bold">第9条（保証の否認および免責事項）</h1>
                    <ol className="flex flex-col gap-2 pt-4 pl-8 list-decimal">
                ...
                <div className="pt-8">
                    ...
                    <p className="pt-4">運営者は，ユーザーへの事前の告知をもって、本サービスの内容を変更、追加または廃止することがあり、ユーザーはこれを承諾するものとします。</p>
                </div>
                <div className="pt-8">
                    <h1 className="text-xl font-bold">第11条（利用規約の変更）</h1>
                    <ol className="flex flex-col gap-2 pt-4 pl-8 list-decimal">
                        <li>運営者は以下の場合には、ユーザーの個別の同意を要せず、本規約を変更することができるものとします。</li>
                        <ol className="flex flex-col gap-2 pt-4 pl-8 list-decimal">
                ...
                <div className="pt-8">
                    ...
                    <p className="pt-4">運営者は，本サービスの利用によって取得する個人情報については，運営者「プライバシーポリシー」に従い適切に取り扱うものとします。</p>
                </div>
                <div className="pt-8">
                    <h1 className="text-xl font-bold">第13条（通知または連絡）</h1>
                    <p className="pt-4">ユーザーと運営者との間の通知または連絡は，運営者の定める方法によって行うものとします。運営者は,ユーザーから,運営者が別途定める方式に従った変更届け出がない限り,現在登録されている連絡先が有効なものとみなして当該連絡先へ通知または連絡を行い,これらは,発信時にユーザーへ到達したものとみなします。</p>
                </div>
                <div className="pt-8">
                    <h1 className="text-xl font-bold">第14条（権利義務の譲渡の禁止）</h1>
                    <p className="pt-4">ユーザーは，運営者の書面による事前の承諾なく，利用契約上の地位または本規約に基づく権利もしくは義務を第三者に譲渡し，または担保に供することはできません。</p>
                </div>
                <div className="pt-8">
