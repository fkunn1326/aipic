...
const Signup = () => {
  ...
  const clickForms = e => {
    supabaseClient.auth.signUp(forms).then((result) => {
        ...
        <div className="w-full bg-white rounded-lg shadow md:mt-0 sm:max-w-md xl:p-0">
          ...
          <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
            ...
            <form className="space-y-2 md:space-y-6" onSubmit={clickForms}>
              ...
              <div>
                <label className="block mb-2 text-sm font-medium text-gray-900">
                  ...
                  <input
                    ...
                    onChange={(e)=>{
                      var textel = document.getElementById("password1_peer") as HTMLElement
                    ...
                    required
                  ></input>
                  <p id="password1_peer" className="mt-2 hidden text-pink-600 text-sm">
                    パスワードは、半角英字、数字、記号を組み合わせて 8 文字以上で入力してください
                  </p>
                </label>
              </div>
              <div>
                <label className="block mb-2 text-sm font-medium text-gray-900">
                  ...
                  <input
                    ...
                    autoComplete="new-password"
                    onChange={(e)=>{
                      var textel = document.getElementById("password2_peer") as HTMLElement
                    ...
                    required
                  ></input>
                  <p id="password2_peer" className="mt-2 hidden text-pink-600 text-sm">
                    上のパスワードと一致する必要があります。
                  </p>
                </label>
              </div>
              ...
              <button
                type="button"
                className="w-full text-white bg-slate-100 hover:bg-slate-200 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium text-gray-900 rounded-lg text-sm px-5 py-2.5 text-center flex justify-center"
