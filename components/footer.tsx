...
const Footer = () => {
  return (
    <footer className="mx-auto px-4 md:px-8 max-w-xl mb:px-0 sm:max-w-7xl">
        <div className="mt-10 pt-10 pb-28 border-t border-slate-200 sm:flex justify-between text-slate-500">
            <div className="mb-6 sm:mb-0 sm:flex items-center space-y-2">
                <p>
                    AIPIC
                </p>
                <p className="text-sm sm:ml-4 sm:pl-4 sm:border-l sm:border-slate-200">
                    <Link href="/terms/tos">
                ...
                <p className="text-sm sm:ml-4">
                    <Link href="/terms/privacy_policy">
                        <a className="text-sky-600 hover:underline">プライバシーポリシー</a>
                    </Link>
                </p>
                <p className="text-sm sm:ml-4">
