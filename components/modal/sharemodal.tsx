    ...
    <Transition appear show={isOpen} as={Fragment}>
      ...
      >
        <div className="h-screen px-4 text-center">
          ...
          >
            <div className="inline-block w-full sm:w-[480px] sm:h-[350px] p-6 my-8 overflow-auto text-left align-middle transition-all transform bg-white dark:bg-slate-900  shadow-xl rounded-xl">
              {children}
            </div>
          </Transition.Child>
        </div>
